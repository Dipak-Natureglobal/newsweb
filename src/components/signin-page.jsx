...
function SingIn() {
    ...
    return (
      ...
      <div className="text-center">
        ...
        <span className="flex items-center justify-center space-x-2 mt-7 flex-col xl:flex-row lg:flex-row mb-36">
      ...
      <div className="fixed bottom-0 left-0 text-white/60 text-xs p-4 w-full bg-[#0d1114] z-10">
        <div className="flex items-start justify-start space-x-2">
          ...
          <p>•</p>
          <p>Developed by <a href="https://dipakdev.in" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-500">Dipak</a></p>
        </div>
      </div>
    </div>
