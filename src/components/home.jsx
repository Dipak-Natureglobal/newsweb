...
function Home(props) {
    ...
    return (
        <div className="bg-white/70 mt-36 mb-16 mx-auto px-4 sm:px-6 lg:px-[6rem] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 min-h-[80vh]">
    {loading ? (  
        <div className="col-span-3 flex justify-center items-center xl:mt-[15rem] lg:mt-[15rem] mt-[20rem]">
